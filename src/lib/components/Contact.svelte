<section id="kontakt" class="relative bg-paper-muted/30 px-6 py-24 lg:px-8 lg:py-32">
	<!-- Decorative elements -->
	<div class="absolute top-0 left-1/2 h-px w-1/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-copper/30 to-transparent"></div>
	...
	<div class="relative mx-auto max-w-6xl">
		...
		<div class="grid gap-12 lg:grid-cols-2">
			...
			<div class="flex flex-col justify-center">
				<p class="mb-6 font-mono text-xs uppercase tracking-wider text-ink-soft">
					Weitere Wege
				</p>
				...
				<div class="space-y-4">
					<!-- GitHub -->
					<a
						href="https://github.com/reneweiser"
						target="_blank"
					...
					>
						<span class="flex h-10 w-10 items-center justify-center rounded-lg bg-ink/5 text-ink-muted transition-colors group-hover:bg-copper/10 group-hover:text-copper">
						...
						<div class="flex-1">
							<p class="font-medium text-ink transition-colors group-hover:text-copper">GitHub</p>
					...
					>
						...
						<div class="flex-1">
							<p class="font-medium text-ink transition-colors group-hover:text-copper">LinkedIn</p>
