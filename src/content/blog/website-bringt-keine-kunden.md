  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Das hängt davon ab, wo das Problem sitzt. Isolierte Fehler — zu schwere Bilder, fehlende Telefonnummer, keine Kundenstimmen — lassen sich gezielt beheben. Wenn die Struktur selbst falsch ist oder du keinen Zugang zu deinem CMS hast, ist ein Neuaufbau oft günstiger als das Flicken.'
        }
      },
      {
        '@type': 'Question',
...
- Telefonnummer auf der Startseite sichtbar machen, ohne zu scrollen
- Google-Bewertungen auf der Website verlinken oder einbinden
- Kontaktformular testen — schick dir selbst eine Testanfrage und prüf, ob sie ankommt
- Deine Website auf dem Smartphone öffnen und durchklicken, als wärst du ein neuer Besucher
...
Das hängt davon ab, wo das Problem sitzt. Isolierte Fehler — zu schwere Bilder, fehlende Telefonnummer, keine Kundenstimmen — lassen sich gezielt beheben. Wenn die Struktur selbst falsch ist oder du keinen Zugang zu deinem CMS hast, ist ein Neuaufbau oft günstiger als das Flicken. Die Entscheidungshilfe dazu steht im Abschnitt weiter oben.
